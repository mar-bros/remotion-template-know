  ...
  return (
    <AbsoluteFill>
      ...
      {globalAudio.questionPopSound && (
        <Sequence from={0}>
          <Audio src={resolveAudio(globalAudio.questionPopSound)!} trimBefore={20} volume={0.2} />
        </Sequence>
      )}
      {globalAudio.countdownSound && (
        <Sequence from={countdownStartFrame} durationInFrames={question.countdownDuration}>
          <Audio src={resolveAudio(globalAudio.countdownSound)!} trimBefore={30} volume={0.2} />
        </Sequence>
      )}
